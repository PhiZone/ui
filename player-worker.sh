...
cd .. &&
  ...
  pnpm i @awesome-cordova-plugins/android-full-screen @capacitor/clipboard @capacitor/filesystem @capacitor/network @ffmpeg/ffmpeg @ffmpeg/util @fix-webm-duration/fix @sentry/sveltekit @tauri-apps/api @tauri-apps/plugin-deep-link @tauri-apps/plugin-fs @tauri-apps/plugin-os @tauri-apps/plugin-upload apng-js bezier-easing context-filter-polyfill cordova-plugin-fullscreen file-type gifuct-js jszip mathjs mime notiflix phaser phaser3-rex-plugins send-intent stats-js wavesurfer.js
