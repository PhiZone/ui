...
<div class="navbar shadow-lg bg-base-100 bg-opacity-50 backdrop-blur-lg text-base">
  <div class="navbar-start z-20">
    <img src="/favicon.ico" alt="logo" class="logo" />
    <a data-sveltekit-preload-data class="title normal-case font-extrabold text-xl" href="/"
      >{$t('common.title')}</a
    >
    <div class="dropdown">
      ...
      >
        ...
        <li>
          <a data-sveltekit-preload-data href="/recorder">{$t('common.navbar.recorder')}</a>
        </li>
    ...
    {#if $page.url.pathname.startsWith('/studio')}
      <label for="studio-sidebar" class="btn btn-primary btn-outline drawer-button lg:hidden"
  ...
  <div class="navbar-end">
    ...
    {#if showUser}
      {#if user}
        <a data-sveltekit-preload-data data-sveltekit-preload-code href="/me/notifications">
          <button class="btn btn-ghost btn-circle">
            <div class="indicator">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="ml-3 dropdown dropdown-end">
          ...
          >
            ...
            {:else}
              <li>
                <a data-sveltekit-preload-data href="/studio">{$t('common.studio')}</a>
              </li>
            {/if}
            <li>
