          ...
          <div class="card-body py-10">
            ...
            <div class="flex">
              <div class="w-1/3">
                ...
                <div class="flex gap-2 items-end w-full justify-start">
                  ...
                  />
                  {#if access_token}
                    <a href={content.song} target="_blank" rel="noreferrer" download>
                  ...
                  {#if audio}
                    ...
                    >
                      <div class="w-9">
                        <p class="text-left">
                          {convertDuration(
                            Math.min(playerState.currentTime, parseDuration(content.duration))
                          )}
                        </p>
                      </div>
                      <div>
                        <div class="flex items-center space-x-3 p-2">
                          ...
                          >
                            <svg class="w-[21px] h-[21px]" viewBox="0 0 24 24" fill="currentColor"
                              ><polygon points="20 20 10 12 20 4 20 20" /><polygon
                                points="10 20 0 12 10 4 10 20"
                              /></svg
                            >
                          </button>
                          {#if playerState.isPlaying}
                            ...
                            >
                              <svg class="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"
                                ><polygon points="5 3 10 3 10 21 5 21 5 3" /><polygon
            ...
            {#if content.charts}
              ...
              <div class="collapse min-h-0">
                <input type="checkbox" class="hidden" bind:checked={showCharts} />
                        ...
                        <ul class="menu bg-base-100 w-full">
                          {#each charts as chart}
                            <li class="border border-base-300">
                              <a href={`/charts/${chart.id}`} class="w-full h-[82px] flex px-5">
                                ...
                                <div class="w-1/6 flex gap-3 items-center justify-end min-w-fit">
                                  <div
