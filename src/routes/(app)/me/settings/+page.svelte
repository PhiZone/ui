          ...
          <div class="card-body py-10">
            ...
            <div class="flex items-center justify-between">
              ...
              <div
                class={genderStatus === Status.ERROR && genderErr
                  ...
                  : 'my-3'}
                data-tip={genderStatus === Status.ERROR && genderErr ? genderErr : ''}
              >
                <button
                  ...
                  on:click={async () => {
                    let data = await submitText('gender', gender, genderStatus, genderErr);
            ...
            <div
              class={usernameStatus === Status.ERROR && usernameErr
                ...
                : 'my-3'}
              data-tip={usernameStatus === Status.ERROR && usernameErr ? usernameErr : ''}
            >
              <label class="input-group">
                ...
                <button
                  ...
                  on:click={async () => {
                    let data = await submitText('username', username, usernameStatus, usernameErr);
            ...
            <div
              class={languageStatus === Status.ERROR && languageErr
                ? 'tooltip tooltip-open tooltip-bottom tooltip-error my-3'
                : 'my-3'}
              data-tip={languageStatus === Status.ERROR && languageErr ? languageErr : ''}
            >
              <label class="input-group">
