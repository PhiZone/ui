<script lang="ts">
  ...
  const getChapters = async () => {
    ...
    const resp = await api.GET('/chapters/?accessibility=0&pagination=0', access_token, user);
    if (resp.ok) {
  ...
  async function handleSubmit() {
    ...
    if (illustration) formData.append('illustration', illustration as unknown as File);
...
<svelte:head>
  <title>
    {$t('studio.song_submission')} - {content?.name} - {$t('common.edit')} | {$t('common.title')}
  </title>
</svelte:head>
          ...
          <div class="card-body">
            ...
            >
              ...
              <div class="flex">
                ...
                {:else}
                  <span class="place-self-center">{$t('common.form.tips.illustration')}</span>
                {/if}
              </div>
              <div
                ...
                <label class="join my-2">
                  ...
                  <input
                    ...
                    class={`input input-bordered join-item w-3/4 min-w-[180px] ${
                      status === Status.ERROR && error?.name ? 'input-error' : 'input-primary'
                    }`}
                    bind:value={songName}
                  />
                </label>
              ...
              >
                <label class="join my-2">
                  ...
                  <input
                    ...
                    class={`input input-bordered join-item w-3/4 min-w-[180px] ${
                      status === Status.ERROR && error?.edition ? 'input-error' : 'input-primary'
                    }`}
                    bind:value={edition}
                  />
                </label>
              ...
              >
                <label class="join my-2">
                  ...
                  <input
                    ...
                    class={`input input-bordered join-item w-3/4 min-w-[180px] ${
                      status === Status.ERROR && error?.composer ? 'input-error' : 'input-primary'
                    }`}
                    bind:value={composer}
                  />
                </label>
              ...
              >
                <label class="join my-2">
                  ...
                  <input
                    ...
                    class={`input input-bordered join-item w-3/4 min-w-[180px] ${
                      status === Status.ERROR && error?.bpm ? 'input-error' : 'input-primary'
                    }`}
                    bind:value={bpm}
                  />
                </label>
              ...
              >
                <label class="join my-2">
                  ...
                  <input
                    ...
                    class={`input input-bordered join-item w-3/4 min-w-[180px] ${
                      status === Status.ERROR && error?.offset ? 'input-error' : 'input-primary'
                    }`}
                    bind:value={offset}
                  />
                </label>
              ...
              >
                ...
                <button
                  class="absolute right-0 top-2 btn btn-accent btn-outline btn-sm join-item"
                  on:click={() => {
              ...
              >
                <label class="join my-2" on:pointerenter={getChapters}>
                  <span class="btn no-animation join-item w-1/4 min-w-[64px]">
                  ...
                  >
                    {#if chapterList}
                      {#each chapterList as chapter, i}
                        <option value={i}>{chapter.title} - {chapter.subtitle}</option>
                      {/each}
                    {/if}
                  </select>
                  <button
