  ...
  <div class="pt-32 pb-8 max-w-[60%] mx-auto form-control">
    <div class="form-control">
      <div class="input-group">
        ...
        >
          <option value="0" selected={type === 0}>{$t('common.chapters')}</option>
        ...
        <input
          type="text"
          placeholder={searchError ? $t(`common.${searchError}`) : $t('common.search_placeholder')}
      ...
      <div class="px-32 result">
        {#each results as result}
          <div class="min-w-fit">
            ...
            {:else if type === 2}
              <div class="w-80">
                <User user={result} token={access_token} operator={user} fixedHeight />
              </div>
            {:else if type === 3}
              施工中（）
            {/if}
